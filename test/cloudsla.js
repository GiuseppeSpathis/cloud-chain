...
contract('Factory', (accounts) => {
    ...
    it('Upload', async() => {
        ...
        const challenge = web3.utils.keccak256(
            web3.eth.abi.encodeParameters(['bytes32'], [hashDigest]), { encoding: 'hex' }
        );
    ...
    it('File check for undeleted file', async() => {
        ...
        await oracleInstance.DigestStore(
            'www.test.com',
            '0x9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', { from: accounts[2] }
        );
    ...
    it('File Check for corrupted file', async() => {
        ...
        await oracleInstance.DigestStore(
            'www.test3.com',
            '0x4f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', { from: accounts[2] }
        );
