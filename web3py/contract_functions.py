...
class ContractTest:
    ...
    async def sequence_read(self, cloud_address: Address, filepath: str, url: str):
        ...
        await self.sign_send_transaction(tx_read_request, self.private_keys[1])
        ...
        await self.sign_send_transaction(tx_read_request_ack, self.private_keys[0])
    ...
    async def sequence_file(self, cloud_address: Address, filepath: str, url: str, hash_digest: str):
        ...
        await self.sign_send_transaction(tx_file_hash_request, self.private_keys[1])
        ...
        await self.sign_send_transaction(tx_digit_store, self.private_keys[2])
        ...
        await self.sign_send_transaction(tx_file_check, self.private_keys[1])
    ...
    async def read(self, cloud_address: Address):
        ...
        await self.sequence_read(cloud_address, filepath, url)
    ...
    async def delete(self, cloud_address: Address):
        ...
        await self.sign_send_transaction(tx_delete_request, self.private_keys[1])
        ...
        await self.sign_send_transaction(tx_delete, self.private_keys[0])
    ...
    async def read_deny_lost_file_check(self, cloud_address: Address):
        ...
        await self.sign_send_transaction(tx_read_request_deny, self.private_keys[0])
    ...
    async def another_file_upload_read(self, cloud_address: Address):
        ...
        await self.sequence_upload(cloud_address, filepath, hash_digest)
        await self.sequence_read(cloud_address, filepath, url)
